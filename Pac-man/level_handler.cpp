...
bool classic_level(string layout, SDL_Renderer* renderer, vector<LTexture*> const &textures, LBitmapFont& font, vector<Mix_Chunk*> const &sounds, vector<Mix_Music*> const& tracks, bool& quit)
{
    ...
    while( !quit and level)
    {
        ...
        handle_collisions(stage, sounds, renderer, textures, font, start_time, quit);
        handle_AIs(stage);
...
void handle_collisions(Stage& stage, vector<Mix_Chunk*> const &sounds, SDL_Renderer* renderer, vector<LTexture*> const &textures, LBitmapFont& font, Uint32 duration, bool& quit)
{
    // pac/gum collision
